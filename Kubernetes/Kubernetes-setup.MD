...
1. create an S3 bucket
   ```sh
    ...
    aws s3 mb s3://demo.k8s.deepcloudusa.com
   ```
1. Expose environment variable:
   ```sh
    export KOPS_STATE_STORE=s3://demo.k8s.valaxy.net
    export KOPS_STATE_STORE=s3://demo.k8s.deepcloudusa.com
   ```
...
1. Create kubernetes cluster definitions on S3 bucket
   ...
   kops create cluster --cloud=aws --zones=ap-south-1b --name=demo.k8s.deepcloudusa.com --dns-zone=deepcloudusa.com --dns private 
